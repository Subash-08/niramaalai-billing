...
export const seed:State={...extensionSeed,
 ...
 suppliers:[
  {id:'S001',name:'Paper Plus Distributors',phone:'9000020001',email:'sales@paperplus.example',address:'Anna Nagar, Chennai',gst:'33DEMOS1234A1Z1',terms:45},
  {id:'S002',name:'Ink & Toner House',phone:'9000020002',email:'orders@inkhouse.example',address:'Pondy Bazaar, Chennai',gst:'33DEMOS5678A1Z2',terms:30},
  {id:'S003',name:'Print Media Wholesale',phone:'9000020003',email:'hello@printmedia.example',address:'Coimbatore, Tamil Nadu',gst:'33DEMOS9012A1Z3',terms:15}],
 bills:[
 ...
 purchases:[
  {id:'PUR-2026-0031',supplierId:'S001',date:'2026-09-08',due:'2026-10-23',reference:'PPD/26/8053',status:'Received',billStatus:'Posted',lines:[makeLine('P001',100,150),makeLine('P002',50,280)],inclusive:true,notes:'Monthly stock replenishment.'},
  {id:'PUR-2026-0032',supplierId:'S002',date:'2026-09-09',due:'2026-10-09',reference:'ITH/26/1944',status:'Received',billStatus:'Posted',lines:[makeLine('P006',20,490),makeLine('P007',15,590)],inclusive:true,notes:'Paid on delivery.'},
  {id:'PUR-2026-0033',supplierId:'S003',date:TODAY,due:'2026-10-10',reference:'PMW/26/1950',status:'Ordered',billStatus:'NotPosted',lines:[makeLine('P004',10,1800),makeLine('P005',5,2200)],inclusive:true,notes:'Delivery expected this week.'}],
 payments:[
  ...
  {id:'PAY-005',date:'2026-09-09',direction:'Out',account:'Bank account',amount:8000,purpose:'Supplier payment',reference:'PUR-2026-0032',party:'S002',note:'Settled in full'},
  {id:'PAY-006',date:TODAY,direction:'Out',account:'Bank account',amount:15000,purpose:'Supplier payment',reference:'PUR-2026-0031',party:'S001',note:'First instalment'}],
 jobs:[],
 enquiries:[
  {id:'ENQ-001',customerId:'C001',date:'2026-09-07',category:'New goods',requirement:'A4 and A3 paper in bulk for the month',budget:10000,status:'Won',followUp:TODAY,notes:'Order placed.'},
  {id:'ENQ-002',customerId:'C002',date:'2026-09-09',category:'New goods',requirement:'Event banners for annual function',budget:8000,status:'Quoted',followUp:'2026-09-11',notes:'Quotation shared.'},
  {id:'ENQ-003',customerId:'C004',date:TODAY,category:'New goods',requirement:'Custom roll labels for product packaging',budget:3000,status:'Open',followUp:TODAY,notes:'Waiting for artwork from customer.'},
  {id:'ENQ-004',customerId:'C005',date:'2026-09-09',category:'New goods',requirement:'Photo prints for wedding album',budget:5000,status:'Open',followUp:'2026-09-12',notes:'Will provide soft copies by Saturday.'}],
 reservations:[],
 returns:[{id:'CN-2026-0001',type:'Customer',reference:'INV-2026-0102',date:TODAY,productId:'P012',qty:2,serials:[],amount:1098,reason:'Two boards damaged in transit',disposition:'Restock',status:'Completed'}],
 warranties:[],
 movements:products.map(p=>({id:'MOV-'+p.id,date:'2026-09-01',productId:p.id,qty:p.stock,reason:'Opening stock',reference:'Opening snapshot'})),
 closings:Array.from({length:8},(_,i)=>({date:`2026-09-${String(i+1).padStart(2,'0')}`,expected:25000,actual:25000,note:i===5?'Weekly holiday':'Opening period reconciled',status:i===5?'Holiday':'Closed',bankActuals:{Cash:25000,'Bank account':240000}})),
 audit:[],
